 ...
 */
public class SchemesForParsing {
    ...
    public String buildRegex(String scheme) {
        ...
        for (char c : scheme.toCharArray()) {
            if (c == 'ف' || c == 'ع' || c == 'ل') {
                //regex += "([\\u0600-\\u06FF][ّ]?)";                
                regex += "([ةئءؤإاآأابتثجحخدذرزسشصضطظعغفقكلمنهوي][ّ]?)";                
       //   } else if (c == 'َ' || c == 'ً' || c == 'ُ' || c == 'ٌ' || c == 'ِ' || c == 'ٍ' || c == 'ْ' || c == 'ّ') {
        ...
        regex += "([ًٌٍَُِّْ]?)";
        regex += "((هُ|هَا|هُمَا|هِمْ|هَمْ|هُمْ|هِنَّ|كَ|كُمَا|كُمْ|كُنَّ|نَا|ي |ةٌ|ةٍ|ةً|ةَ|ةُ|ةِ|ا|اءِ|اءُ|اءَ |هُ|هِ|هَ|نِي|هَا|هُمَا|هُمْ|هُنَّ|كَ|كُمَا|كُمْ|كُنَّ|نَاهُ|نَاهَا|نَاهُمَا|نَاهُمْ|نَاهُنَّ|نَاكَ|نَاكُمَا|نَاكُمْ|نَاكُنَّ|نَا|تُ|تِ|تَ|تُمَا|تُمْ|تُنَّ |وهُ|ا|ونَكُمْ|اتٌ)?)";        regex = regex + "$";
    ...
    public String schemesMatcher(String word,
        ...
        Pattern dhamirRaf3 = Pattern.compile("^(فَ|وَ)?"
                + "(أَنَا|أَنْتَ|أَنْتِ|هُوَ|هِيَ|نَحْنُ|أَنْتُمَا|هُمَا|أَنْتُمْ|أَنْتُنَّ|هُمْ|هُمُ|هُنّ)$");
        ...
        Pattern harf3atf = Pattern.compile("^(فَ|وَ)?"
                + "(ثُمَّ|أَوْ|أَمْ|لَكِنْ|بَلْ|وَ|حَتَّى)$");
...
//----------------------------------------------------------------------
      ...
      //-------------------------------------------------------------------------------
        ...
        //----------------------------------------------------------------------		
        Pattern Tan9it = Pattern.compile("([\\p{Punct}ۖۖۖ؛،ۚۛۙ؟ۗ\\s+؛])");

        w = Tan9it.matcher(word);
        while (w.find()) {
            return "_تنقيط_";
        }
  //----------------------------------------------------------------------		
        Pattern Fi3lMoudha3af = Pattern.compile("(^[ةئءؤإاآأابتثجحخدذرزسشصضطظعغفقكلمنهوي][َ][ةئءؤإاآأابتثجحخدذرزسشصضطظعغفقكلمنهوي][ّ][َ]$)");
        ...
        //                       Schemes Matcher
        //======================================================================    
     word = word.replaceAll("ى", "اَ");  // أجلى-> أجلا      
     //word = word.replaceAll("ا", "اَ");  // عاد->   adding hamza under al alif to identify verb al ajwaf
     //word = word.replaceAll("ًاَ", "ًا");  // cancel previous rule if it's tanwin at the end of word : مُسْرِعًا
     ...
     for (int j = 0; j < scheme.size() ; j++) {                
        ...
        if( word.length() > 3 
                && word.charAt(word.length() - 1) == 'َ' 
                && word.charAt(word.length() - 2) == 'ن'
                && word.charAt(word.length() - 3) == 'ي'
                && word.charAt(word.length() - 4) == 'ِ'
                ){
            Diacritic = "3_";
        }
         //---------------------------------------------------------------------
         if( word.length() > 3 
                && word.charAt(word.length() - 1) == 'َ' 
                && word.charAt(word.length() - 2) == 'ن'
                && word.charAt(word.length() - 3) == 'و'
                && word.charAt(word.length() - 4) == 'ُ'
                ){
            Diacritic = "2_";
        }
        ...
        //----------------------------------------------------------------------
         if( word.length() > 3 
                && word.charAt(word.length() - 1) == 'ِ' 
                && word.charAt(word.length() - 2) == 'ن'
                && word.charAt(word.length() - 3) == 'ا'
                && word.charAt(word.length() - 4) == 'َ'
                ){
            Diacritic = "2_";
        }
